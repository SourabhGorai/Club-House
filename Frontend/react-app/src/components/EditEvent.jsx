...
import DateTimePicker from "./Datetimepicker"; // <-- import custom picker
import {
...
export default function EditEvent({
  ...
  const dark =
    typeof isDarkMode === "boolean"
      ? isDarkMode
      : Boolean(externalTheme?.isDarkMode);

  const theme = {
    primaryColor: dark ? "#D946EF" : "#4CA1AF",
    primaryLight: dark ? "rgba(217, 70, 239, 0.15)" : "rgba(76, 161, 175, 0.1)",
    primaryGradient: dark
      ? "linear-gradient(135deg, #D946EF, #A21CAF)"
      : "linear-gradient(135deg, #4CA1AF, #2C3E50)",
    cardHeaderGradient: dark
      ? "linear-gradient(135deg, #A21CAF 0%, #701A75 100%)"
      : "linear-gradient(135deg, #4CA1AF, #2C3E50)",
    bgCard: dark ? "#343541" : "#FFFFFF",
    accentSoft: dark ? "#414854" : "#F8FCFF",
    borderColor: dark ? "#4B5563" : "#D1D5DB",
    textPrimary: dark ? "#ECECF1" : "#111827",
  ...
  // ── Location search (Photon — CORS-safe) ─────────────────────────────────
  ...
  // ── Input change (text, number, checkbox) ─────────────────────────────────
  ...
  // Generic setter for DateTimePicker fields
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto">
      ...
      <div className="flex min-h-full items-center justify-center p-4">
        <div
          className="relative rounded-2xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto edit-event-scroll"
          style={{
            scrollbarWidth: "none",
        ...
        >
          ...
          <style>{`
            .edit-event-scroll::-webkit-scrollbar { display: none; }
          `}</style>

          {/* Header */}
          <div
            className="sticky top-0 border-b border-gray-200 px-6 py-4 rounded-t-2xl z-10 flex items-center justify-between"
            style={{ background: theme.cardHeaderGradient || theme.primaryGradient }}
          >
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6" style={{ color: theme.textPrimary }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  style={{
                    ...
                    backgroundColor: formErrors.title ? "rgba(239,68,68,0.08)" : theme.accentSoft,
              ...
              <div>
                <label className="block text-sm font-medium mb-1" style={{ color: theme.textSecondary }}>Speaker Name</label>
                <input
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-2.5 border rounded-lg focus:ring-2 focus:border-transparent transition-all resize-none"
                style={{
                  borderColor: theme.borderColor,
                  backgroundColor: theme.accentSoft,
                  color: theme.textPrimary,
            ...
            {/* ── Row 3: Date + Deadline — using DateTimePicker ── */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <DateTimePicker
                  ...
                  onChange={handleDateTimeChange("dateTime")}
              ...
              <div>
                <DateTimePicker
                  ...
                  maxValue={formData.dateTime || undefined}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2.5 border rounded-lg focus:ring-2 focus:border-transparent transition-all"
                    style={{
                      borderColor: formErrors.venue ? "#FCA5A5" : theme.borderColor,
                      backgroundColor: formErrors.venue ? "rgba(239,68,68,0.08)" : theme.accentSoft,
                      color: theme.textPrimary,
                    }}
                  />
                </div>
              ...
              <div>
                <label className="block text-sm font-medium mb-1" style={{ color: theme.textSecondary }}>Maximum Enrollments</label>
                <input
              ...
              <div className="flex flex-wrap gap-3">
                {[
                  ...
                  <button
                    ...
                    style={formData.targetType === key ? { backgroundColor: theme.primaryLight } : { borderColor: theme.borderColor, color: theme.textSecondary }}
                  >
                    ...
                    {getTargetOptions().map((item) => {
                      ...
                      return (
                        <div
                          ...
                          style={selected ? { backgroundColor: theme.primaryLight } : { backgroundColor: theme.bgCard, borderColor: theme.borderColor }}
                        >
                          <span className="text-sm font-medium" style={{ color: theme.textSecondary }}>{item.name}</span>
            ...
            <div className="border-t pt-5" style={{ borderColor: theme.borderColor }}>
              ...
              <p className="mt-1 text-xs ml-13" style={{ color: theme.textMuted }}>
            ...
            {showMap && (
              <div className="space-y-5 p-5 rounded-xl border" style={{ backgroundColor: theme.accentSoft, borderColor: theme.borderColor }}>
                <h3 className="text-sm font-semibold" style={{ color: theme.textPrimary }}>📍 Select Event Location on Map</h3>
                ...
                {/* Attendance window — using DateTimePicker */}
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <DateTimePicker
                  ...
                  <div>
                    <DateTimePicker
                      ...
                      minValue={formData.attendanceWindowStart || undefined}
            ...
            {/* ── Actions ── */}
            <div className="flex justify-end gap-3 pt-4 border-t" style={{ borderColor: theme.borderColor }}>
              <button
                type="button" onClick={onClose}
                className="px-6 py-2.5 border rounded-lg font-medium transition-colors"
                style={{ borderColor: theme.borderColor, color: theme.textSecondary, backgroundColor: theme.accentSoft }}
              >
                Cancel
              </button>
              <button
