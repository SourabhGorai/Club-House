          ...
          >
            <div className="flex flex-col lg:flex-row min-h-[500px] lg:min-h-[650px]">
              ...
              <div className="w-full lg:w-1/2 px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12 py-6 sm:py-8 md:py-10 flex flex-col justify-center relative order-2 lg:order-1">
                ...
                <div className="relative z-10 w-full max-w-md mx-auto lg:mx-0">
                  ...
                  <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-5 md:mb-6">
                    <div 
                      className="w-8 sm:w-9 md:w-10 h-8 sm:h-9 md:h-10 rounded-lg sm:rounded-xl flex items-center justify-center"
                      style={{ background: 'var(--primary-gradient)' }}
                    >
                      <svg className="w-4 sm:w-5 md:w-6 h-4 sm:h-5 md:h-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                      </svg>
                    </div>
                    ...
                    >
                      {isLoading ? (
                        <>
                          ...
                          <span className="text-white text-sm sm:text-base">Creating Account...</span>
                        </>
                      ) : (
                        <>
                          <span className="text-white text-sm sm:text-base tracking-wider">CREATE ACCOUNT</span>
                          <svg
              ...
              >
                ...
                {/* Main illustration */}
                <div className="relative z-10 w-full h-full flex flex-col items-center justify-center p-6 lg:p-8 xl:p-12">
                  <div className="mb-4 lg:mb-6 xl:mb-8">
                    <h3 className="text-xl lg:text-2xl xl:text-3xl font-bold text-white text-center">
                      Join Us Today!
                    </h3>
                    <p className="text-white/80 text-center mt-1 lg:mt-2 text-sm lg:text-base">
                      Create your account and unlock amazing features
                    </p>
                  </div>
                  ...
                  <div className="relative w-full max-w-md">
                    {/* Floating card elements */}
                    <div className="absolute -top-4 lg:-top-6 -right-4 lg:-right-6 w-24 lg:w-28 xl:w-32 h-24 lg:h-28 xl:h-32 bg-white/20 rounded-2xl lg:rounded-3xl rotate-12"></div>
                    <div className="absolute -bottom-4 lg:-bottom-6 -left-4 lg:-left-6 w-24 lg:w-28 xl:w-32 h-24 lg:h-28 xl:h-32 bg-white/10 rounded-2xl lg:rounded-3xl -rotate-12"></div>
                    
                    {/* Main illustration image */}
                    <div className="relative z-10 bg-gradient-to-br from-white/20 to-white/5 backdrop-blur-sm rounded-2xl lg:rounded-3xl p-4 lg:p-6 xl:p-8 border border-white/20">
                      <div className="flex items-center justify-center mb-3 lg:mb-4 xl:mb-6">
                        <div className="w-14 lg:w-16 xl:w-20 h-14 lg:h-16 xl:h-20 rounded-full bg-gradient-to-br from-white to-[#4CA1AF]/20 flex items-center justify-center shadow-2xl">
                          <svg className="w-7 lg:w-8 xl:w-10 h-7 lg:h-8 xl:h-10" style={{ color: 'var(--primary-color-1)' }} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z" />
                          </svg>
                        </div>
                      </div>
                      <div className="space-y-2 lg:space-y-3 xl:space-y-4">
                        <div className="h-2 lg:h-2.5 xl:h-3 bg-white/30 rounded-full w-3/4 mx-auto"></div>
                        <div className="h-2 lg:h-2.5 xl:h-3 bg-white/20 rounded-full w-2/3 mx-auto"></div>
                        <div className="h-2 lg:h-2.5 xl:h-3 bg-white/10 rounded-full w-1/2 mx-auto"></div>
                      </div>
                    </div>
                  </div>

                  {/* Features list - responsive grid */}
                  <div className="grid grid-cols-2 gap-3 lg:gap-4 xl:gap-6 mt-6 lg:mt-8 xl:mt-12 w-full max-w-md">
                    <div className="flex items-center gap-2 lg:gap-3">
                      <div className="w-6 lg:w-7 xl:w-8 h-6 lg:h-7 xl:h-8 rounded-full bg-white/20 flex items-center justify-center flex-shrink-0">
                        <svg className="w-3 lg:w-3.5 xl:w-4 h-3 lg:h-3.5 xl:h-4 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                        </svg>
                      </div>
                      <span className="text-white text-xs lg:text-sm xl:text-base">Secure Account</span>
                    </div>
                    <div className="flex items-center gap-2 lg:gap-3">
                      <div className="w-6 lg:w-7 xl:w-8 h-6 lg:h-7 xl:h-8 rounded-full bg-white/20 flex items-center justify-center flex-shrink-0">
                        <svg className="w-3 lg:w-3.5 xl:w-4 h-3 lg:h-3.5 xl:h-4 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      ...
                      <span className="text-white text-xs lg:text-sm xl:text-base">Instant Access</span>
                    </div>
                    <div className="flex items-center gap-2 lg:gap-3">
                      <div className="w-6 lg:w-7 xl:w-8 h-6 lg:h-7 xl:h-8 rounded-full bg-white/20 flex items-center justify-center flex-shrink-0">
                        <svg className="w-3 lg:w-3.5 xl:w-4 h-3 lg:h-3.5 xl:h-4 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      ...
                      <span className="text-white text-xs lg:text-sm xl:text-base">Multiple Roles</span>
                    </div>
                    <div className="flex items-center gap-2 lg:gap-3">
                      <div className="w-6 lg:w-7 xl:w-8 h-6 lg:h-7 xl:h-8 rounded-full bg-white/20 flex items-center justify-center flex-shrink-0">
                        <svg className="w-3 lg:w-3.5 xl:w-4 h-3 lg:h-3.5 xl:h-4 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      ...
                      <span className="text-white text-xs lg:text-sm xl:text-base">Full Features</span>
                    </div>
                  </div>
                </div>
              </div>
