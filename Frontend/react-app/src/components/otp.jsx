...
//   return (
//     <div className="min-h-screen bg-gradient-to-br from-orange-100 via-rose-50 to-sky-100 flex items-center justify-center p-5">
//       <div className="max-w-md w-full mx-auto mt-6 p-8 bg-gradient-to-br from-white to-gray-50 shadow-2xl rounded-2xl border border-gray-100 transform transition-all duration-300 hover:shadow-2xl">
...
//             <button
//               type="button"
//               className="text-orange-500 hover:text-orange-600 ml-1 cursor-pointer font-medium transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-orange-300 rounded px-1"
//             >
//               Resend OTP
//             </button>
//           </div>
