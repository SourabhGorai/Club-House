...
export default function CreateEvent() {
  ...
  // Generic setter for DateTimePicker fields (value is a string directly)
  ...
  // Min datetime string for DateTimePicker (1 hour from now)
      ...
      <div className="relative max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-xl border border-white/20 overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="p-8 space-y-8">
            ...
            {/* Row 3: Event Date & Enrollment Deadline — using DateTimePicker */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <DateTimePicker
