...
//     // Attendance fields with default coordinates (college location example)
//     latitude: "18.5204", // Default: Pune, India
//     longitude: "73.8567",
//     radiusInMeters: 50,
...
//       setMessage({
//         text: "Failed to load clubs/departments",
//         type: "error",
//       });
//     } finally {
...
//     let updatedTargets;
//     if (exists) {
//       updatedTargets = selectedTargets.filter(t => t.id !== target.id);
//     } else {
//       updatedTargets = [...selectedTargets, target];
//     }
...
//         name: item.name || item.departmentName || "Unnamed Department"
//       }));
//     }
//     return [];
//   };
...
//           {/* Status Message */}
//           {message.text && (
//             <div className={`mx-8 mt-6 p-4 rounded-lg flex items-center gap-2 ${
//               message.type === "error"
...
//                       formErrors.eventDate ? "border-red-300 bg-red-50" : "border-gray-300"
//                     }`}
//                     style={{focus: {ringColor: '#4CA1AF'}}}
//                   />
//                 </div>
...
//                     className={`w-full pl-10 pr-4 py-2.5 border rounded-lg focus:ring-2 focus:border-transparent transition-colors cursor-pointer ${
//                       formErrors.enrollmentDeadline ? "border-red-300 bg-red-50" : "border-gray-300"
//                     }`}
//                     style={{focus: {ringColor: '#4CA1AF'}}}
//                   />
//                 </div>
...
//                   }`}
//                   style={formData.target === "GLOBAL" ? {backgroundColor: 'rgba(76, 161, 175, 0.1)'} : {}}
//                 >
...
//                       : "border-gray-300 hover:border-[#4CA1AF] hover:bg-[#4CA1AF]/5"
//                   }`}
//                   style={formData.target === "CLUB" ? {backgroundColor: 'rgba(76, 161, 175, 0.1)'} : {}}
//                 >
...
//                               {isSelected && (
//                                 <Check className="w-4 h-4" style={{color: '#4CA1AF'}} />
//                               )}
//                             </div>
//                           );
//                         })
...
//                   </div>
//                 </div>
//                 <span className="text-sm font-medium text-gray-700">Enable Attendance Tracking with Geofencing</span>
//               </label>
...
//                 {/* Map Instructions */}
//                 <div className="rounded-lg p-3" style={{backgroundColor: 'rgba(76, 161, 175, 0.1)', borderColor: '#4CA1AF', borderWidth: '1px'}}>
//                   <p className="text-xs flex items-center gap-2" style={{color: '#4CA1AF'}}>
//                     <Layers className="w-4 h-4" />
//                     <span>Click on the map to set the event location. Drag the marker to adjust. The circle shows the geofencing radius.</span>
//                   </p>
//                 </div>
//                 {formErrors.location && (
