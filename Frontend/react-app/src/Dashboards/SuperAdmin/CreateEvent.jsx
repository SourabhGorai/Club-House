...
const LIGHT_PRIMARY_GRADIENT =
  "linear-gradient(135deg, #4CA1AF 0%, #2c7a8a 100%)";
...
export default function CreateEvent() {
  ...
  const theme = {
    ...
    primaryGradient: isDarkMode
      ? DARK_PRIMARY_GRADIENT
      : LIGHT_PRIMARY_GRADIENT,
    ...
    borderColorHover: isDarkMode
      ? DARK_BORDER_COLOR_HOVER
      : LIGHT_BORDER_COLOR_HOVER,
  ...
  const fetchTargetOptions = async () => {
    ...
    try {
      ...
      if (deptResponse.data.success && Array.isArray(deptResponse.data.data)) {
        setDepartments(
          deptResponse.data.data.filter((dept) => dept.active === true),
        );
      } else if (Array.isArray(deptResponse.data)) {
        setDepartments(deptResponse.data);
      } else {
  ...
  const sendEventNotification = async (eventId, eventTitle) => {
    try {
      ...
      console.log(
        "Sending event notification with payload:",
        notificationPayload,
      );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data.success) {
        const createdEventId =
          response.data.data?.eventId || response.data.data?.id || null;
        await sendEventNotification(createdEventId, formData.title);
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
          <div className="flex justify-between items-center h-14 sm:h-16">
            ...
            <div className="flex items-center gap-1.5 sm:gap-2">
              ...
              />
              <span
                className="text-xs sm:text-sm md:text-base font-semibold truncate max-w-[150px] sm:max-w-none"
      ...
      <div className="relative max-w-7xl mx-auto py-4 sm:py-6 md:py-8 px-2 sm:px-4 md:px-6 lg:px-8">
        ...
        >
          ...
          <form
            ...
            className="p-3 sm:p-4 md:p-6 lg:p-8 space-y-4 sm:space-y-5 md:space-y-6 lg:space-y-8"
          >
            {/* Responsive Grid Layout */}
            <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 md:gap-5 lg:gap-6">
              {/* Title Field */}
              <div>
                ...
                />
                {formErrors.title && (
                  <p className="mt-0.5 sm:mt-1 text-xs text-red-600">
                    {formErrors.title}
                  </p>
                )}
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  placeholder={
                    isMobile ? "e.g., Dr. Smith" : "e.g., Dr. John Smith"
                  }
                  className="w-full px-3 sm:px-4 py-2 sm:py-2.5 text-sm sm:text-base border rounded-lg focus:ring-2 focus:border-transparent transition-colors cursor-text"
                  style={{
                    background: theme.accentSoft,
            ...
            <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 md:gap-5 lg:gap-6">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    placeholder={
                      isMobile ? "e.g., Main Hall" : "e.g., Main Auditorium"
                    }
              ...
              <div>
                ...
                <input
                  ...
                  style={{
                    background: theme.accentSoft,
                    borderColor: formErrors.maxEnrollments
                      ? "#fca5a5"
                      : theme.borderColor,
                    color: theme.textPrimary,
                  }}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  style={{
                    background: theme.accentSoft,
                    borderColor: formErrors.contactEmail
                      ? "#fca5a5"
                      : theme.borderColor,
                    color: theme.textPrimary,
                  }}
                ...
                {[
                  {
                    ...
                    label: isMobile ? "Global" : "Global (Everyone)",
                  },
                  {
                    value: "CLUB",
                    icon: <Users className="w-3 h-3 sm:w-4 sm:h-4" />,
                    label: isMobile ? "Clubs" : "Specific Clubs",
                  },
                  {
                    value: "DEPARTMENT",
                    icon: <Building2 className="w-3 h-3 sm:w-4 sm:h-4" />,
                    label: isMobile ? "Depts" : "Specific Departments",
                  },
                ].map(({ value, icon, label }) => (
                  <button
                    key={value}
            ...
            {formData.target !== "GLOBAL" && (
              <div>
                ...
                {loadingOptions ? (
                  <div
                    className="flex items-center justify-center py-4 sm:py-6 md:py-8 rounded-lg"
                  ...
                  >
                    <div className="max-h-48 sm:max-h-60 overflow-y-auto theme-scrollbar">
                      {targetOptions.length > 0 ? (
                        targetOptions.map((item) => {
                          ...
                          return (
                            ...
                            >
                              <span
                                className="text-xs sm:text-sm font-medium truncate pr-2"
                                style={{ color: theme.textPrimary }}
                              >
                                {item.name}
                              </span>
                        ...
                        <div
                          className="px-3 sm:px-4 py-4 sm:py-6 md:py-8 text-center text-xs sm:text-sm"
                ...
                {formErrors.targetIds && (
                  <p className="mt-1.5 sm:mt-2 text-xs text-red-600">
                    {formErrors.targetIds}
                  </p>
                )}
              </div>
            ...
            {/* Attendance Tracking Toggle */}
            <div
              className="border-t pt-4 sm:pt-5 md:pt-6"
            ...
            >
              <label className="flex items-center gap-2 sm:gap-3 cursor-pointer">
                <div className="relative flex-shrink-0">
                  ...
                  />
                  <div
                    className={`w-8 sm:w-10 h-4 sm:h-6 rounded-full transition-colors ${enableAttendance ? "" : "bg-gray-300"}`}
                    style={{
                      backgroundColor: enableAttendance
                        ? theme.primaryColor
                        : isDarkMode
                          ? "#4B5563"
                          : "#D1D5DB",
                  ...
                  >
                    <div
                      className={`w-3 sm:w-4 h-3 sm:h-4 rounded-full bg-white transform transition-transform absolute top-0.5 sm:top-1 ${enableAttendance ? "translate-x-4 sm:translate-x-5" : "translate-x-1 sm:translate-x-1"}`}
                    />
                  </div>
                </div>
                <span
              ...
              <p
                className="mt-0.5 sm:mt-1 text-xs ml-8 sm:ml-13"
                style={{ color: theme.textMuted }}
              >
                Set up location-based attendance using map selection
              </p>
            ...
            {enableAttendance && (
              ...
              >
                  ...
                  <div className="flex-1 relative">
                    <input
                      ...
                      placeholder={
                        isMobile
                          ? "Search location..."
                          : "Search for a location (e.g. Bharati Vidyapeeth, Pune)..."
                      }
                ...
                <div className="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-2 md:grid-cols-3 gap-2 sm:gap-3 md:gap-4 mt-3 sm:mt-4">
                  <div>
                    <label
                      className="block text-xs font-medium mb-0.5 sm:mb-1"
                      style={{ color: theme.textSecondary }}
                    >
                      Latitude
                    </label>
                ...
                >
                  <p
                    className="text-xs flex items-center gap-1.5 sm:gap-2"
                    style={{ color: theme.primaryColor }}
                  >
                    <Layers className="w-3 h-3 sm:w-4 sm:h-4 flex-shrink-0" />
                    <span className="text-xs">
            ...
            {/* Form Actions - Responsive */}
            <div
              className="flex flex-col xs:flex-row gap-2 sm:gap-3 md:gap-4 pt-4 sm:pt-5 md:pt-6 border-t"
              style={{ borderColor: theme.borderColor }}
            >
              <button
                type="button"
        ...
        <div className="mt-4 sm:mt-6 md:mt-8 text-center">
          <div
            className="inline-flex items-center space-x-1.5 sm:space-x-2 text-xs sm:text-sm"
            style={{ color: theme.textMuted }}
          >
            <Bell className="w-3 h-3 sm:w-4 sm:h-4" />
            <span>
