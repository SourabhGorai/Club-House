...
export default function SuperAdminDashboard() {
  ...
  const StatCard = ({ title, count, icon: Icon, bgColor, iconColor }) => (
    <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex items-center space-x-5 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 cursor-pointer group">
      <div
        ...
        style={{backgroundColor: bgColor || 'rgba(76, 161, 175, 0.1)', color: iconColor || '#4CA1AF'}}
      >
  ...
  const BigActionButton = ({ label, icon: Icon, onClick, bgColor, iconColor, hoverColor }) => (
    <button
      onClick={onClick}
    ...
    >
      ...
      <span
        className="text-lg font-bold text-gray-700 transition-colors text-center px-2"
        style={{color: hoverColor ? '#374151' : undefined}}
      >
        {label}
      </span>
    </button>
    ...
    return (
      <div className="min-h-screen bg-[#fcfcfd] flex items-center justify-center">
        <div className="text-center">
          <div className="animate-spin rounded-full h-16 w-16 border-b-2 mx-auto mb-4 cursor-wait" style={{borderColor: '#4CA1AF'}}></div>
    ...
    <div className="min-h-screen bg-[#fcfcfd] flex relative">
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 bg-white border-b border-gray-100 px-4 py-4 flex items-center justify-between z-50 shadow-sm">
        ...
        <div className="flex items-center space-x-2">
          <div className="p-2 rounded-lg transition-transform hover:scale-105 cursor-pointer" style={{background: 'linear-gradient(135deg, #4CA1AF, #315169)'}}>
        ...
        <div className="w-10 h-10 rounded-full overflow-hidden border-2 transition-all hover:border-[#4CA1AF] hover:scale-105 cursor-pointer" style={{borderColor: 'rgba(76, 161, 175, 0.2)'}}>
          <img
            src={
              imagePreview ||
      ...
      >
        ...
        <div className="flex items-center space-x-3 mb-10 group cursor-pointer">
          <div className="p-2.5 rounded-xl shadow-lg transition-all duration-300 group-hover:scale-105 cursor-pointer" 
        ...
        <div className="flex flex-col items-center text-center mb-8">
          <div className="relative p-1 border-2 rounded-3xl mb-4 transition-all duration-300 hover:shadow-lg cursor-pointer" 
               style={{borderColor: 'rgba(76, 161, 175, 0.2)', boxShadow: '0 10px 15px -3px rgba(76, 161, 175, 0.1)'}}>
            <img
              src={
                imagePreview ||
                `https://ui-avatars.com/api/?name=${profileData.fullName || currentUser.username}&background=4CA1AF&color=fff`
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <section>
            <div className="flex items-center space-x-4 mb-8">
              ...
              <div className="flex-1 h-[2px] bg-gradient-to-r from-gray-200 to-gray-200 rounded-full"
                   style={{backgroundImage: 'linear-gradient(to right, #e5e7eb, #4CA1AF, #e5e7eb)'}}></div>
            </div>
      ...
      {showProfileForm && (
        <div className="fixed inset-0 bg-gray-900/40 backdrop-blur-md flex items-center justify-center p-6 z-50 overflow-y-auto">
          <div className="bg-white rounded-[2.5rem] shadow-2xl max-w-2xl w-full my-8 overflow-hidden border border-white">
            <div className="p-8 text-white" style={{background: 'linear-gradient(135deg, #4CA1AF, #315169)'}}>
            ...
            <form onSubmit={handleSubmitProfile} className="p-8 space-y-5">
              <div className="flex flex-col items-center mb-6">
                <div className="relative">
                  <img
                    ...
                    style={{borderColor: 'rgba(76, 161, 175, 0.2)'}}
                  />
                  <label className="absolute bottom-0 right-0 p-2 rounded-full cursor-pointer hover:scale-110 transition-all shadow-lg"
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:border-transparent transition-all ${userProfile ? "bg-gray-100 cursor-not-allowed" : ""}`}
            ...
            <div className="p-8 flex-1 overflow-y-auto">
              ...
              <form onSubmit={handleDeptSubmit} className="mb-8">
                <div className="flex gap-3">
                  <input
                    ...
                    className="flex-1 px-4 py-3 border-2 border-gray-100 rounded-xl focus:ring-2 focus:border-transparent transition-all outline-none"
                    style={{focus: {ringColor: '#4CA1AF'}}}
                    value={deptInput}
              ...
              {deptLoading ? (
                <div className="py-10 text-center text-gray-500 italic">
                  <div className="animate-spin rounded-full h-8 w-8 border-b-2 mx-auto mb-3 cursor-wait" style={{borderColor: '#4CA1AF'}}></div>
                  Loading departments...
                </div>
              ) : (
                  ...
                  {departments.length > 0 ? (
                    departments.map((dept) => (
                      <div
                        ...
                        className="flex items-center justify-between p-4 bg-gray-50/50 rounded-2xl border border-gray-100 transition-all group cursor-pointer"
