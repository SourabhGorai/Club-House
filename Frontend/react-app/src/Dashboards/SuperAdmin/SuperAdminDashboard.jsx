    ...
    <div className="bg-white rounded-[2.5rem] shadow-2xl max-w-2xl w-full max-h-[85vh] overflow-hidden border border-white flex flex-col">
      <div className="bg-purple-600 p-8 text-white flex justify-between items-center">
        <div>
          ...
          <p className="text-purple-100 text-sm opacity-90">Add or remove academic departments</p>
        </div>
        <button
          onClick={() => {
      ...
      <div className="p-8 flex-1 overflow-y-auto">
        ...
        <form onSubmit={handleDeptSubmit} className="mb-8">
          <div className="flex gap-3">
            ...
            <button
              type="submit"
              className="bg-purple-600 hover:bg-purple-700 text-white px-6 py-3 rounded-xl font-bold transition-all flex items-center gap-2 whitespace-nowrap shadow-lg shadow-purple-100"
            >
          ...
          {editingDept && (
            <div className="mt-2 text-sm text-gray-500 flex items-center gap-2">
              <span>Editing: <span className="font-bold">{editingDept.name}</span></span>
              <button
                type="button"
                onClick={() => {
                  setEditingDept(null);
            ...
            {departments.length > 0 ? (
              departments.map((dept) => (
                <div 
                  ...
                  className="flex items-center justify-between p-4 bg-gray-50/50 rounded-2xl border border-gray-100 hover:border-purple-200 hover:bg-purple-50/30 transition-all group"
                >
