    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50">
      ...
      <div className="relative max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        {filteredEvents.length === 0 ? (
          ...
          <div
            className={`grid ${viewMode === "grid" ? "grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4" : "grid-cols-1"} gap-4`}
          >
              ...
              return (
                ...
                >
                  <div className="event-card">
                    ...
                    <div className="card-face card-front bg-white/90 backdrop-blur-sm rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-all duration-500 border border-white/20">
                      ...
                      <div className="p-3 space-y-2">
                        ...
                        <div className="grid grid-cols-2 gap-1">
                          ...
                          <div className="bg-gray-50 p-1.5 rounded-lg">
                            <p className="text-[8px] text-gray-500">Created By</p>
                            <p className="text-xs font-semibold text-gray-800 flex items-center truncate">
                    ...
                    <div className="card-face card-back rounded-xl shadow-md overflow-hidden p-3" 
                         style={{ background: "linear-gradient(135deg, #4CA1AF, #2C3E50)" }}>
                      <div className="h-full flex flex-col">
                        ...
                        <div className="space-y-1.5 overflow-y-auto flex-1 pr-1 custom-scrollbar text-xs">
                          ...
                          {/* <div className="p-1.5 rounded-lg" style={{ backgroundColor: "rgba(255, 255, 255, 0.1)" }}>
                            ...
                            <p className="text-xs font-medium text-white line-clamp-2">{event.description}</p>
                          </div> */}
                          ...
                          <div className="grid grid-cols-2 gap-1">
                            ...
                            <div className="p-1.5 rounded-lg" style={{ backgroundColor: "rgba(255, 255, 255, 0.1)" }}>
                              <div className="flex items-center mb-0.5">
                                ...
                                <p className="text-[10px] text-white/80">Deadline</p>
                              </div>
                          ...
                          {/* <div className="p-1.5 rounded-lg" style={{ backgroundColor: "rgba(255, 255, 255, 0.1)" }}>
                            ...
                            <p className="text-xs font-medium text-white line-clamp-1">{event.venue}</p>
                          </div> */}

                          {/* Organizer & Creator Details */}
                          {/* <div className="p-1.5 rounded-lg" style={{ backgroundColor: "rgba(255, 255, 255, 0.1)" }}>
                            <p className="text-[10px] text-white/80 mb-1">Organized by</p>
                            <div className="flex items-center justify-between">
                              <div>
                                <p className="text-xs font-medium text-white line-clamp-1">{event.organizer}</p>
                                <p className="text-[8px] text-white/70">Organizer</p>
                              </div>
                              <div className="text-right">
                                <p className="text-xs font-medium text-white line-clamp-1">{event.creatorName}</p>
                                <p className="text-[8px] text-white/70">PRN: {event.creatorPrn}</p>
                              </div>
                            </div>
                          </div> */}
                          ...
                          <div className="p-1.5 rounded-lg" style={{ backgroundColor: "rgba(255, 255, 255, 0.1)" }}>
                            ...
                            <div className="w-full h-1.5 rounded-full overflow-hidden" style={{ backgroundColor: "rgba(255, 255, 255, 0.2)" }}>
                              <div
                                ...
                                style={{ width: `${enrollmentPercentage}%`, backgroundColor: "#4CA1AF" }}
                              ></div>
                            </div>
                          </div>

                          {/* Attendance Window - Compact */}
                          {/* <div className="p-1.5 rounded-lg" style={{ backgroundColor: "rgba(255, 255, 255, 0.1)" }}>
                            <div className="flex items-center justify-between">
                              <div className="flex items-center">
                                <CalendarClock className="w-3 h-3 mr-1 text-white/80" />
                                <span className="text-[10px] text-white/80">Attendance</span>
                              </div>
                              <span className="text-[8px] text-white/70">{event.qrRefreshInterval}s</span>
                            </div>
                            <p className="text-[10px] text-white mt-0.5">
                              {new Date(event.attendanceWindowStart).toLocaleTimeString([], {hour: '2-digit', minute:'2-digit'})}
                            </p>
                          </div> */}
                        </div>
                        ...
                        <div className="mt-2 pt-1 border-t border-white/20 flex items-center justify-between">
                          <span className={`text-[8px] font-medium px-1.5 py-0.5 rounded-full ${
                            event.enrollmentStatus?.toLowerCase() === "open"
                              ...
                              : event.enrollmentStatus?.toLowerCase() === "closed"
                          ...
                          <span className={`text-[8px] font-medium px-1.5 py-0.5 rounded-full ${
                            event.completed ? "bg-gray-500/30" : "bg-blue-500/30"
                          } text-white`}>
...
//                     {/* Status Badge and Admin Actions - Top Right */}
...
//                         <span>
//                           {event.maxEnrollments - event.currEnrollments} spots
//                           left
//                         </span>
//                       </div>
//                     </div>
...
//                           QR Refresh: {event.qrRefreshInterval}s
//                         </span>
//                       </div>
...
//                           Coordinates: {event.latitude.toFixed(4)},{" "}
