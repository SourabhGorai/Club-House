import { User, Plus, Upload, X, CalendarDays, Edit, LogOut, LayoutDashboard, Settings, BookOpen, ShieldCheck, Mail, Phone, AtSign, Users, Club, ChevronRight, CheckCircle, AlertCircle } from "lucide-react";
      ...
      <main className="flex-1 p-10 overflow-y-auto max-h-screen">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          ...
          <StatCard 
            ...
            value={currentUser?.verified ? "Verified" : "Pending"} 
            color="purple" 
            isStatus 
          />
        </div>
                    ...
                    try {
                      ...
                      if (response.data) {
                        ...
                        try {
                          ...
                          localStorage.setItem("verificationReturnUrl", "/users-dashboard");
