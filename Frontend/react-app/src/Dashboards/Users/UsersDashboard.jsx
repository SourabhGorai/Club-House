...
//             {/* User Control Center */}
//             <section className="bg-white rounded-2xl sm:rounded-3xl md:rounded-[2.5rem] p-4 sm:p-6 md:p-8 lg:p-10 shadow-sm border border-gray-50 h-fit">
...
//                     }
//                     disabled={!isVerified}
//                     className="p-4 sm:p-6 md:p-8 rounded-xl sm:rounded-2xl border border-gray-50/50 transition-all hover:scale-[1.02] flex flex-col items-center justify-center gap-2 sm:gap-4 group shadow-sm w-full relative disabled:opacity-40 disabled:cursor-not-allowed"
//                     style={{ backgroundColor: "rgba(76, 161, 175, 0.05)" }}
//                   >
//                     <div
//                       className="relative p-3 sm:p-4 bg-white rounded-lg sm:rounded-xl shadow-sm group-hover:shadow-md transition-all group-hover:-translate-y-1"
//                       style={{ color: "#4CA1AF" }}
//                     >
...
//                       )}
//                     </div>
//                     <span className="font-black text-gray-700 uppercase text-[10px] sm:text-xs tracking-widest">
//                       Notifications
//                     </span>
//                   </button>
//                 </div>
...
//   // Same color palette as super admin dashboard
//   const PRIMARY_COLOR = "#4CA1AF";
//   const PRIMARY_DARK = "#2d8391";
//   const PRIMARY_LIGHT = "rgba(76, 161, 175, 0.1)";
//   const PRIMARY_GRADIENT = "linear-gradient(135deg, #4CA1AF 0%, #2c7a8a 100%)";
  
//   // Very light sky blue color palette (same as super admin)
//   const BG_MAIN = "#f5faff"; // Ultra light sky blue
//   const BG_GRADIENT = "linear-gradient(135deg, #f5faff 0%, #f0f8ff 100%)";
//   const BG_SIDEBAR = "#ffffff"; // Clean white sidebar
//   const BG_CARD = "#ffffff"; // White cards
//   const BORDER_COLOR = "#e9f0f9"; // Very soft blue border
//   const BORDER_COLOR_HOVER = "#d9e6f5";
//   const TEXT_PRIMARY = "#1e293b"; // Dark slate
//   const TEXT_SECONDARY = "#475569"; // Medium slate
//   const TEXT_MUTED = "#64748b"; // Light slate
//   const ACCENT_SOFT = "#f8fcff"; // Extremely light blue for hover states
...
//       >
//         <div className="text-center p-8 rounded-2xl" style={{ background: BG_CARD, border: `1px solid ${BORDER_COLOR}` }}>
//           <div
//             className="animate-spin rounded-full h-16 w-16 border-b-2 mx-auto mb-4 cursor-wait"
//             style={{ borderColor: PRIMARY_COLOR }}
//           ></div>
//           <p className="font-semibold" style={{ color: TEXT_SECONDARY }}>Loading dashboard...</p>
//         </div>
//       </div>
//     );
//   }
...
//           style={{ background: 'rgba(255, 255, 255, 0.95)', borderBottom: `1px solid ${BORDER_COLOR}` }}
//         >
//           <button
//             onClick={() => setSidebarOpen(!sidebarOpen)}
...
//               <LayoutDashboard className="text-white w-5 h-5" />
//             </div>
//             <h2 className="text-xl font-black tracking-tight" style={{ color: TEXT_PRIMARY }}>
//               User<span style={{ color: PRIMARY_COLOR }}>Portal</span>
//             </h2>
//           </div>
//           <div
...
//               />
//             ) : (
//               <div className="w-full h-full flex items-center justify-center" style={{ background: ACCENT_SOFT }}>
//                 <User size={20} style={{ color: TEXT_MUTED }} />
//               </div>
//             )}
//           </div>
//         </div>
...
//             boxShadow: "4px 0 20px rgba(76, 161, 175, 0.05)"
//           }}
//         >
//           <button
//             onClick={() => setSidebarOpen(false)}
...
//           <div className="flex items-center gap-3 mb-8 group cursor-pointer">
//             <div
//               className="p-2 rounded-xl shadow-lg transition-all duration-300 group-hover:scale-105 cursor-pointer"
//               style={{
//                 background: PRIMARY_GRADIENT,
//                 boxShadow: `0 10px 15px -3px ${PRIMARY_COLOR}30`,
//               }}
//             >
//               <LayoutDashboard className="text-white w-7 h-7" />
//             </div>
...
//           {/* Profile Image */}
//           <div className="relative group mx-auto mb-6">
//             <div className="w-32 h-32 sm:w-40 sm:h-40 rounded-[2.5rem] overflow-hidden transition-all duration-300 hover:shadow-lg"
//               style={{ 
//                 border: `2px solid ${PRIMARY_LIGHT}`,
//                 boxShadow: `0 10px 15px -3px ${PRIMARY_COLOR}20`,
//               }}
//             >
//               {profileImage ? (
//                 <img
...
//               ) : (
//                 <div className="w-full h-full flex items-center justify-center" style={{ background: ACCENT_SOFT }}>
//                   <User size={48} style={{ color: TEXT_MUTED }} />
//                 </div>
//               )}
//             </div>
//             <button
//               onClick={() => setShowProfileForm(true)}
//               className="absolute bottom-1 right-1 p-2.5 rounded-xl shadow-lg transition-all duration-200 hover:scale-110 cursor-pointer"
...
//           <div className="text-center mb-6">
//             <h2 className="text-xl sm:text-2xl font-bold tracking-tight leading-tight" style={{ color: TEXT_PRIMARY }}>
//               {profileData.fullName || user?.username}
//             </h2>
//             <span
//               className="mt-2 inline-block text-[10px] font-black px-4 py-1.5 rounded-full uppercase tracking-widest"
...
//               style={{ background: ACCENT_SOFT, border: `1px solid ${BORDER_COLOR}` }}
//             >
//               <p className="text-[9px] uppercase font-black mb-1 tracking-widest transition-colors" style={{ color: TEXT_MUTED }}>
//                 Email
//               </p>
//               <div className="flex items-center justify-between">
//                 <span className="font-bold text-sm truncate pr-2" style={{ color: TEXT_PRIMARY }}>
//                   {currentUser.email}
//                 </span>
//                 <div className="flex gap-1">
//                   <button
...
//                     }}
//                     className="p-1.5 rounded-lg transition-all duration-200 hover:scale-110 flex-shrink-0 cursor-pointer"
//                     style={{ color: PRIMARY_COLOR, background: `${PRIMARY_COLOR}10` }}
//                     title="Edit email"
//                   >
//                     <Edit size={14} />
//                   </button>
...
//               })
//             }
//             className="mt-4 flex items-center justify-center gap-3 py-4 rounded-[1.5rem] transition-all border cursor-pointer"
//             style={{ 
//               color: '#ef4444',
//               background: BG_CARD,
//               borderColor: BORDER_COLOR,
...
//           <header className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6 sm:mb-8 md:mb-10">
//             <div>
//               <h1 className="text-2xl sm:text-3xl font-bold tracking-tight" style={{ color: TEXT_PRIMARY }}>
//                 Dashboard
//               </h1>
//               <p className="text-sm sm:text-base mt-1" style={{ color: TEXT_SECONDARY }}>
//                 Welcome back,{" "}
...
//             {/* User Control Center */}
//             <section 
//               className="rounded-2xl sm:rounded-3xl md:rounded-[2.5rem] p-4 sm:p-6 md:p-8 lg:p-10 shadow-sm h-fit"
...
//                   }}
//                 ></div>
//                 <h2 className="text-xl sm:text-2xl font-bold" style={{ color: TEXT_PRIMARY }}>
//                   User Control Center
//                 </h2>
//               </div>
...
//                       </svg>
//                     </div>
//                     <p className="font-bold text-sm" style={{ color: TEXT_SECONDARY }}>Verify your email to access these features</p>
//                     <button
//                       onClick={handleVerificationRedirect}
//                       className="text-xs font-bold px-5 py-2 bg-amber-500 text-white rounded-full hover:bg-amber-600 transition-colors cursor-pointer"
//                     >
...
//                     style={{ background: ACCENT_SOFT, borderColor: BORDER_COLOR }}
//                   >
//                     <div
...
//                       style={{ background: BG_CARD, color: PRIMARY_COLOR }}
//                     >
//                       <Bell size={18} className="sm:w-5 sm:h-5 md:w-6 md:h-6" />
//                       {unreadCount > 0 && (
//                         <span className="absolute -top-1.5 -right-1.5 w-4 h-4 sm:w-5 sm:h-5 bg-red-500 text-white text-[8px] sm:text-[10px] font-black rounded-full flex items-center justify-center">
...
//                       )}
//                     </div>
//                     <span className="font-black uppercase text-[10px] sm:text-xs tracking-widest" style={{ color: TEXT_PRIMARY }}>
//                       Notifications
//                     </span>
//                   </button>
//                 </div>
...
//             {(isLoadingClubs || clubsError || myClubs.length > 0) && (
//             <section 
//               className="rounded-2xl sm:rounded-3xl md:rounded-[2.5rem] p-4 sm:p-6 md:p-8 lg:p-10 shadow-sm"
//               style={{ background: BG_CARD, border: `1px solid ${BORDER_COLOR}` }}
//             >
//               <div className="flex items-center justify-between mb-6 sm:mb-8">
//                 <h2 className="text-xl sm:text-2xl font-bold" style={{ color: TEXT_PRIMARY }}>My Clubs</h2>
//                 <button
//                   onClick={fetchMyClubs}
//                   disabled={isLoadingClubs || !isVerified}
//                   className="flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full text-xs sm:text-sm font-bold transition-all duration-200 hover:scale-105 disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:scale-100 whitespace-nowrap"
...
//                   style={{ borderColor: BORDER_COLOR, background: ACCENT_SOFT }}>
//                   <div className="bg-amber-100 w-16 h-16 sm:w-20 sm:h-20 rounded-full flex items-center justify-center mx-auto mb-4">
//                     <svg className="w-8 h-8 sm:w-9 sm:h-9 text-amber-500" fill="currentColor" viewBox="0 0 20 20">
//                       <path fillRule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clipRule="evenodd" />
//                     </svg>
//                   </div>
//                   <h3 className="text-lg font-bold mb-2" style={{ color: TEXT_PRIMARY }}>Clubs Locked</h3>
//                   <p className="text-sm mb-6 px-4" style={{ color: TEXT_SECONDARY }}>
//                     Verify your email address to view and manage your club memberships.
//                   </p>
//                   <button
//                     onClick={handleVerificationRedirect}
...
//                     </svg>
//                   </div>
//                   <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3" style={{ color: TEXT_PRIMARY }}>
//                     Unable to Load Clubs
//                   </h3>
//                   <p className="text-red-500/70 text-sm sm:text-base mb-4 sm:mb-5">{clubsError}</p>
//                   <button
...
//                     <Users style={{ color: TEXT_MUTED }} className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12" />
//                   </div>
//                   <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3" style={{ color: TEXT_PRIMARY }}>
//                     No Clubs Joined Yet
//                   </h3>
//                   <p className="text-sm sm:text-base mb-6 sm:mb-8 px-4" style={{ color: TEXT_SECONDARY }}>
//                     You haven't joined any clubs. Explore and join clubs to see
//                     them here.
//                   </p>
//                   <button
...
//           <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center p-4 z-50">
//             <div 
//               className="rounded-[2.5rem] shadow-2xl max-w-xl w-full p-8"
//               style={{ background: BG_CARD, border: `1px solid ${BORDER_COLOR}` }}
//             >
//               <div className="flex justify-between items-center mb-8">
//                 <h3 className="text-2xl font-bold" style={{ color: TEXT_PRIMARY }}>
//                   {userProfile ? "Edit Profile" : "Complete Profile"}
//                 </h3>
//                 <button
//                   onClick={() => setShowProfileForm(false)}
//                   className="p-2 rounded-full transition-colors cursor-pointer"
//                   style={{ background: ACCENT_SOFT, color: TEXT_SECONDARY }}
//                 >
//                   <X size={20} />
//                 </button>
//               </div>
...
//                 <div className="grid grid-cols-2 gap-4">
//                   <div className="space-y-1">
//                     <label className="text-[10px] font-black ml-1 uppercase tracking-widest" style={{ color: TEXT_MUTED }}>
//                       Department
//                     </label>
//                     <select
//                       value={profileData.departmentId}
...
//                     style={{ color: TEXT_SECONDARY }}
//                   >
//                     <Upload size={24} style={{ color: PRIMARY_COLOR }} />
//                     <span className="text-sm font-semibold">
//                       {selectedImage
//                         ? selectedImage.name
//                         : "Upload Profile Photo"}
...
//             <div 
//               className="rounded-[2.5rem] shadow-2xl max-w-md w-full overflow-hidden"
//               style={{ background: BG_CARD, border: `1px solid ${BORDER_COLOR}` }}
//             >
//               <div
//                 className="p-6 text-white"
...
// function SidebarInfoBox({ label, value, primaryColor, primaryLight, textPrimary, textSecondary, borderColor }) {
//   return (
//     <div 
//       className="p-4 rounded-[1.2rem] transition-colors group cursor-pointer"
//       style={{ background: primaryLight, border: `1px solid ${borderColor}` }}
//     >
//       <p className="text-[9px] uppercase font-black mb-1 tracking-widest transition-colors" style={{ color: textSecondary }}>
//         {label}
//       </p>
...
// function StatCard({ icon, label, value, color, isStatus, disabled, primaryColor, primaryLight, textPrimary, bgCard, borderColor }) {
//   const bgColors = {
//     blue: { bg: primaryLight, text: primaryColor },
//     orange: { bg: "rgba(249, 115, 22, 0.1)", text: "#F97316" },
//     purple: { bg: primaryLight, text: primaryColor },
//     green: { bg: "rgba(16, 185, 129, 0.1)", text: "#10B981" },
//     red: { bg: "rgba(239, 68, 68, 0.1)", text: "#EF4444" },
//   };
//   return (
...
//       </div>
//       <div>
//         <p className="text-xs font-black uppercase tracking-widest mb-1" style={{ color: textPrimary }}>
//           {label}
//         </p>
//         <h3
//           className={`text-2xl font-black tracking-tight ${
...
//               : ""
//           }`}
//           style={{ color: isStatus ? undefined : textPrimary }}
//         >
//           {value}
//         </h3>
//       </div>
...
// function CompactClubCard({ club, onViewDetails, disabled, primaryColor, primaryLight, textPrimary, textSecondary, accentSoft, borderColor }) {
//   const clubName = club.clubName || club.name || "Unnamed Club";
//   const clubDescription =
//     club.description || club.desc || "No description available";
//   const memberCount = club.memberCount || club.members || "0";
...
//             </h3>
//           </div>
//           <p className="text-sm line-clamp-2 mb-2" style={{ color: textSecondary }}>
//             {clubDescription}
//           </p>
//           <div className="flex items-center gap-1.5">
...
// function ActionCard({ icon, label, color, onClick, disabled, primaryColor, primaryLight, bgCard, borderColor, textPrimary }) {
//   const themes = {
//     blue: { bg: primaryLight, icon: primaryColor },
//     orange: { bg: "rgba(249, 115, 22, 0.05)", icon: "#F97316" },
//     green: { bg: "rgba(16, 185, 129, 0.05)", icon: "#10B981" },
//     purple: { bg: primaryLight, icon: primaryColor },
//   };
//   return (
//     <button
//       onClick={onClick}
...
//           : "hover:scale-[1.02] cursor-pointer"
//       }`}
//       style={{ background: themes[color].bg, borderColor: borderColor }}
//     >
//       <div
//         className="p-4 rounded-xl shadow-sm group-hover:shadow-md transition-all group-hover:-translate-y-1"
//         style={{ background: bgCard, color: themes[color].icon }}
//       >
//         {icon}
//       </div>
//       <span className="font-black uppercase text-xs tracking-widest" style={{ color: textPrimary }}>
//         {label}
//       </span>
//     </button>
//   );
...
// function FormInput({ label, primaryColor, bgCard, accentSoft, borderColor, textPrimary, textSecondary, textMuted, ...props }) {
//   return (
//     <div className="space-y-1">
//       <label className="text-[10px] font-black ml-1 uppercase tracking-widest" style={{ color: textMuted }}>
//         {label}
//       </label>
//       <input
