...
//   // Dark mode colors
//   const DARK_PRIMARY_COLOR = "#5fb3c0";
//   const DARK_PRIMARY_DARK = "#3d8a97";
//   const DARK_PRIMARY_LIGHT = "rgba(95, 179, 192, 0.15)";
//   const DARK_PRIMARY_GRADIENT = "linear-gradient(135deg, #5fb3c0 0%, #3d8a97 100%)";
  
//   const DARK_BG_MAIN = "#0f172a";
//   const DARK_BG_GRADIENT = "linear-gradient(135deg, #0f172a 0%, #1e293b 100%)";
//   const DARK_BG_SIDEBAR = "#1e293b";
//   const DARK_BG_CARD = "#334155";
//   const DARK_BORDER_COLOR = "#475569";
//   const DARK_BORDER_COLOR_HOVER = "#64748b";
...
//           <div className="relative group mx-auto mb-6">
//             <div 
//               className="w-32 h-32 sm:w-40 sm:h-40 rounded-[2.5rem] overflow-hidden transition-all duration-300 hover:shadow-lg"
//               style={{ 
...
//           <div className="text-center mb-6">
//             <h2 className="text-xl sm:text-2xl font-bold tracking-tight leading-tight" style={{ color: theme.textPrimary }}>
//               {profileData.fullName || user?.username}
//             </h2>
//             <span
//               className="mt-2 inline-block text-[10px] font-black px-4 py-1.5 rounded-full uppercase tracking-widest"
...
//             >
//               <p className="text-[9px] uppercase font-black mb-1 tracking-widest transition-colors" style={{ color: theme.textMuted }}>
//                 Email
//               </p>
//               <div className="flex items-center justify-between">
//                 <span className="font-bold text-sm truncate pr-2" style={{ color: theme.textPrimary }}>{currentUser.email}</span>
//                 <div className="flex gap-1">
//                   <button
//                     onClick={() => { setNewEmail(currentUser.email); setShowEmailEditModal(true); }}
//                     className="p-1.5 rounded-lg transition-all duration-200 hover:scale-110 flex-shrink-0 cursor-pointer"
...
//               })
//             }
//             className="mt-4 flex items-center justify-center gap-3 py-4 rounded-[1.5rem] transition-all border cursor-pointer hover:bg-red-50 hover:border-red-200"
//             style={{ 
//               color: '#ef4444',
...
//                     style={{ background: isDarkMode ? 'rgba(15, 23, 42, 0.8)' : 'rgba(255, 255, 255, 0.6)' }}
//                   >
//                     <div className="bg-amber-100 p-4 rounded-full">
//                       <svg className="w-8 h-8 text-amber-500" fill="currentColor" viewBox="0 0 20 20">
//                         <path fillRule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clipRule="evenodd" />
...
export default function TeachersDashboard() {
  ...
  // Dark mode colors - ChatGPT style (light grey)
