  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const theme =
          JSON.parse(localStorage.getItem("userRemoveFromClubTheme")) === "dark"
            ? DARK_PRIMARY_COLOR
            : LIGHT_PRIMARY_COLOR;
  ...
  useEffect(() => {
    ...
    if (selectedClub) {
      ...
      filtered = filtered.filter((user) => {
        const byClubId =
          user.clubId != null && String(user.clubId) === selectedClubKey;
        const byClubName =
          user.clubName != null && String(user.clubName) === selectedClubKey;
    ...
    return (
      <>
        ...
        >
          ...
          ></div>
          <p
            className="mt-4 font-medium animate-pulse tracking-wide"
            style={{ color: theme.textMuted }}
          >
            {teacherPrn
    ...
    <>
      ...
      `}</style>
        ...
        <div className="max-w-7xl mx-auto px-4 py-6 sm:py-8 sm:px-6 lg:px-8 relative z-10">
          ...
          {error && (
            <div
              className="mb-6 flex items-center p-4 border-l-4 rounded-xl"
              style={{
                  ...
                  <div className="hidden lg:block">
                    <table className="w-full text-left border-collapse">
                      <thead>
                        ...
                        >
                          <th
                            className="px-10 py-6 text-[11px] font-black uppercase tracking-[0.2em]"
                            style={{ color: theme.textMuted }}
                          >
                            Member
                          </th>
                          ...
                          <th
                            className="px-10 py-6 text-right text-[11px] font-black uppercase tracking-[0.2em]"
                            style={{ color: theme.textMuted }}
                          >
                            Actions
                          </th>
                      ...
                      >
                        {pagedUsers.map((user) => {
                          ...
                          return (
                            <tr
                              key={user.userClubId}
                              className="group transition-all duration-300 hover:bg-opacity-5"
                              style={{
                                hover: {
                            ...
                            >
                              ...
                              <td className="px-10 py-6">
                                <div className="space-y-1">
                                  ...
                                  <p
                                    className="text-xs font-bold ml-5"
                                    style={{ color: theme.textMuted }}
                                  >
                                  ...
                                  <button
                                    onClick={() =>
                                      setConfirmDialog({
                                        ...
                                        message: `Are you sure you want to remove ${user.name} from ${user.clubName}?`,
                                        confirmText: "Remove",
                                        variant: "danger",
                                        onConfirm: () => {
                                          closeConfirm();
                          ...
                          {isExpanded && (
                            <>
                              <div className="mt-3 grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm">
                                ...
                                <div
                                  className="flex items-center font-bold sm:col-span-2"
                                  style={{ color: theme.textSecondary }}
                                >
                                  <Briefcase
                                    size={14}
              ...
              <div className="flex items-center gap-2">
                ...
                {Array.from(
                  ...
                  .filter(
                    (i) =>
                      i === 0 ||
                      i === Math.ceil(filteredUsers.length / PAGE_SIZE) - 1 ||
          ...
          {/* Footer */}
          <div
            className="mt-10 flex flex-col md:flex-row items-center justify-between text-[10px] font-black uppercase tracking-[0.12em] sm:tracking-[0.2em] px-2 sm:px-6 opacity-60 gap-3"
            style={{ color: theme.textMuted }}
          >
            <p>
