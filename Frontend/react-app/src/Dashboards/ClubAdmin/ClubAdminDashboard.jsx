...
export default function ClubAdminDashboard() {
  ...
  // Theme colors
  const theme = {
    bgMain: isDarkMode ? "#343541" : "#f5faff",
    bgGradient: isDarkMode ? "linear-gradient(135deg, #343541 0%, #2A2B36 100%)" : "linear-gradient(135deg, #f5faff 0%, #f0f8ff 100%)",
    bgCard: isDarkMode ? "#444654" : "#ffffff",
    textPrimary: isDarkMode ? "#ECECF1" : "#1e293b",
    textSecondary: isDarkMode ? "#C5C5D2" : "#475569",
    borderColor: isDarkMode ? "#4D4F5E" : "#e9f0f9",
    accentSoft: isDarkMode ? "rgba(255, 255, 255, 0.05)" : "rgba(0, 0, 0, 0.05)",
  };
  ...
  return (
    <>
    <div className="min-h-screen p-2 sm:p-3 md:p-4 lg:p-6 safe-area-top safe-area-bottom transition-colors duration-300"
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 sm:mb-6 md:mb-8 gap-3 sm:gap-4">
          <div>
            <h1 className="text-xl sm:text-2xl md:text-4xl font-bold" style={{ color: isDarkMode ? "#D946EF" : "#059669" }}>Club Admin Dashboard 🎯</h1>
            <p className="text-xs sm:text-sm mt-1" style={{ color: theme.textSecondary }}>Club management and member coordination</p>
          </div>
          <div className="flex items-center gap-2 sm:gap-3 md:gap-4 w-full sm:w-auto flex-wrap">
            <ThemeToggle />
            <span className="px-2 sm:px-3 py-1 rounded-full text-xs sm:text-sm font-medium transition-colors duration-300"
              style={{ 
                background: isDarkMode ? "rgba(217, 70, 239, 0.15)" : "rgba(5, 150, 105, 0.1)",
                color: isDarkMode ? "#D946EF" : "#059669"
              }}>
              CLUB_ADMIN
            </span>
            <button
              ...
              className="cursor-pointer hover:opacity-90 text-white px-3 sm:px-4 py-2 rounded-lg transition duration-300 text-xs sm:text-sm whitespace-nowrap"
              style={{ background: isDarkMode ? "#ae123e" : "#dc2626" }}
            >
              Logout
            </button>
          </div>
         ...
         {/* Welcome Message */}
          <div className="my-3 sm:my-4 md:my-6 rounded-lg sm:rounded-xl shadow-md sm:shadow-lg p-3 sm:p-4 md:p-6 transition-colors duration-300"
            ...
            <div className="border rounded-lg p-2 sm:p-3 md:p-4 transition-colors duration-300"
              style={{ 
                background: isDarkMode ? "rgba(234, 179, 8, 0.05)" : "rgba(254, 243, 199, 1)",
                borderColor: isDarkMode ? "rgba(234, 179, 8, 0.2)" : "rgba(253, 224, 71, 1)",
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-3 md:gap-4 lg:gap-6">
          {/* Club Members */}
          <div className="rounded-lg sm:rounded-xl shadow-md sm:shadow-lg p-3 sm:p-4 md:p-6 transition-colors duration-300"
            style={{ background: theme.bgCard, borderColor: theme.borderColor, border: `1px solid ${theme.borderColor}` }}>
            <div className="flex items-center mb-3 sm:mb-4">
              <div className="p-2 sm:p-3 rounded-lg mr-2 sm:mr-3 md:mr-4 transition-colors duration-300"
                style={{ background: isDarkMode ? "rgba(217, 70, 239, 0.15)" : "rgba(5, 150, 105, 0.1)" }}>
                <Users className="w-5 sm:w-6 h-5 sm:h-6" style={{ color: isDarkMode ? "#D946EF" : "#059669" }} />
              </div>
              <h3 className="text-base sm:text-lg md:text-xl font-semibold" style={{ color: isDarkMode ? "#D946EF" : "#059669" }}>Club Members</h3>
            </div>
            <p className="text-2xl sm:text-3xl md:text-4xl font-bold mb-2" style={{ color: isDarkMode ? "#D946EF" : "#059669" }}>45</p>
            <p className="text-xs sm:text-sm" style={{ color: theme.textSecondary }}>Active members</p>
          </div>
          ...
          <div className="rounded-lg sm:rounded-xl shadow-md sm:shadow-lg p-3 sm:p-4 md:p-6 transition-colors duration-300"
            ...
            <div className="flex items-center mb-3 sm:mb-4">
              <div className="p-2 sm:p-3 rounded-lg mr-2 sm:mr-3 md:mr-4 transition-colors duration-300"
               ...
               <Calendar className="w-5 sm:w-6 h-5 sm:h-6" style={{ color: isDarkMode ? "#3b82f6" : "#1e40af" }} /> 
              </div>
              <h3 className="text-base sm:text-lg md:text-xl font-semibold" style={{ color: isDarkMode ? "#3b82f6" : "#1e40af" }}>Upcoming Events</h3>
            </div>
            <p className="text-2xl sm:text-3xl md:text-4xl font-bold mb-2" style={{ color: isDarkMode ? "#3b82f6" : "#1e40af" }}>3</p>
            <p className="text-xs sm:text-sm" style={{ color: theme.textSecondary }}>This week</p>
          </div>
          ...
          <div className="rounded-lg sm:rounded-xl shadow-md sm:shadow-lg p-3 sm:p-4 md:p-6 transition-colors duration-300"
            ...
            <div className="flex items-center mb-3 sm:mb-4">
              <div className="p-2 sm:p-3 rounded-lg mr-2 sm:mr-3 md:mr-4 transition-colors duration-300"
                style={{ background: isDarkMode ? "rgba(168, 85, 247, 0.15)" : "rgba(168, 85, 247, 0.1)" }}>
                <CalendarRange className="w-5 sm:w-6 h-5 sm:h-6" style={{ color: isDarkMode ? "#a855f7" : "#6b21a8" }} />
              </div>
              <h3 className="text-base sm:text-lg md:text-xl font-semibold" style={{ color: isDarkMode ? "#a855f7" : "#6b21a8" }}>All Previous Events</h3>
            </div>
          ...
          {/* Club Management */}
          <div className="rounded-lg sm:rounded-xl shadow-md sm:shadow-lg p-3 sm:p-4 md:p-6 sm:col-span-2 lg:col-span-3 transition-colors duration-300"
            style={{ background: theme.bgCard, borderColor: theme.borderColor, border: `1px solid ${theme.borderColor}` }}>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-2 sm:gap-3 md:gap-4">
                 <button 
                  ...
                  className="cursor-pointer hover:opacity-90 text-white py-2 sm:py-3 rounded-lg transition duration-300 text-xs sm:text-sm"
                  style={{ background: isDarkMode ? "#16a34a" : "#16a34a" }}>
                Add Members
              </button>
               <button 
              ...
              <button 
                  ...
                  className="cursor-pointer hover:opacity-90 text-white py-2 sm:py-3 rounded-lg transition duration-300 text-xs sm:text-sm"
                  style={{ background: isDarkMode ? "#3b82f6" : "#3b82f6" }}>
                Schedule Event
              </button>
              <button className="hover:opacity-90 text-white py-2 sm:py-3 rounded-lg transition duration-300 text-xs sm:text-sm"
                style={{ background: isDarkMode ? "#a855f7" : "#a855f7" }}>
                Create Notification/Alert
              </button>
              <button className="cursor-pointer hover:opacity-90 text-white py-2 sm:py-3 rounded-lg transition duration-300 text-xs sm:text-sm"
                style={{ background: isDarkMode ? "#f97316" : "#f97316" }}>
                Club Settings
              </button>
            </div>
          </div>
          ...
          <div className="rounded-lg sm:rounded-xl shadow-md sm:shadow-lg p-3 sm:p-4 md:p-6 sm:col-span-2 lg:col-span-3 transition-colors duration-300"
            style={{ background: theme.bgCard, borderColor: theme.borderColor, border: `1px solid ${theme.borderColor}` }}>
            <h3 className="text-base sm:text-lg md:text-xl font-semibold mb-3 sm:mb-4" style={{ color: theme.textPrimary }}>all nonsense Recent Club Activity</h3>
            <div className="space-y-2 sm:space-y-3">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center p-2 sm:p-3 rounded-lg gap-2 transition-colors duration-300"
                style={{ background: theme.accentSoft }}>
                <span className="text-xs sm:text-sm" style={{ color: theme.textSecondary }}>New member registration - John Doe</span>
                <span className="text-xs whitespace-nowrap" style={{ color: theme.textSecondary }}>2 hours ago</span>
              </div>
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center p-2 sm:p-3 rounded-lg gap-2 transition-colors duration-300"
                style={{ background: theme.accentSoft }}>
                <span className="text-xs sm:text-sm" style={{ color: theme.textSecondary }}>Weekly meeting scheduled</span>
                <span className="text-xs whitespace-nowrap" style={{ color: theme.textSecondary }}>1 day ago</span>
              </div>
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center p-2 sm:p-3 rounded-lg gap-2 transition-colors duration-300"
                style={{ background: theme.accentSoft }}>
                <span className="text-xs sm:text-sm" style={{ color: theme.textSecondary }}>Budget approved for new equipment</span>
                <span className="text-xs whitespace-nowrap" style={{ color: theme.textSecondary }}>2 days ago</span>
              </div>
            </div>
          </div>
        </div>
